...
# from src.kubernetes_job_yaml_operator import KubernetesJobYamlOperator
...
# KubernetesJobYamlOperator(task_id="test-job-success", job_yaml=success_job_yaml, dag=dag)

# KubernetesJobYamlOperator(task_id="test-job-fail", job_yaml=fail_job_yaml, dag=dag)
