...
KubernetesJobOperator(task_id="test-job-success", body=success_body, envs=envs, dag=dag)
KubernetesJobOperator(task_id="test-job-fail", body=fail_body, envs=envs, dag=dag)
